...
Public Sub UpdateStyles()
  ...
  Dim Item As Style: For Each Item In ActiveWorkbook.Styles: With Item
    ...
    If .Name = DefStyle And ChgNorm Then .Font.Size = BdySize
    If .Name = DefStyle And ChgNorm Then .Font.Name = BdyFont
    
    If .Name = "xCond" Then
      .Font.Name = Range("FontTable[Cond]")
    ElseIf .Name = "xMono" Then
      .Font.Name = Range("FontTable[Mono]")
    Else
      .IncludeFont = ChgFont
