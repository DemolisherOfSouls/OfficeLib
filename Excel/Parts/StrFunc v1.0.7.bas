...
Public Function EndsWith(ByVal checktext As String, ByVal fortext As String) As Boolean
  EndsWith = InStr(checktext, fortext) = (Len(checktext) - Len(fortext) + 1) And InStr(checktext, fortext) > 0
End Function
...
Public Function ReplaceMany(ByVal Source As String, ByVal Rep1 As String, ByVal With1 As String, _
  Optional ByVal Rep2 As String = NoParam, Optional ByVal With2 As String = NoParam, _
  Optional ByVal Rep3 As String = NoParam, Optional ByVal With3 As String = NoParam) _
  As String
    ReplaceMany = Replace(Source, Rep1, With1)
    If Rep2 <> NoParam Then ReplaceMany = Replace(ReplaceMany, Rep2, With2)
    If Rep3 <> NoParam Then ReplaceMany = Replace(ReplaceMany, Rep3, With3)
End Function
...
Public Function IfError2(ByVal checkvalue, ByVal valueiferror)
  IfError = IIf(IsError(checkvalue), valueiferror, checkvalue)
End Function
